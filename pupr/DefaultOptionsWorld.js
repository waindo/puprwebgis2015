...
//	May use new NASA WMTS : http://onearth.jpl.nasa.gov/wms.cgi?request=GetCapabilities
     ...
     */
     ...
     new OpenLayers.Layer.WMS(
            "Indonesia",
            'http://localhost:8080/geoserver/pupr2015/wms?',
            {layers: "pupr2015:indonesia_prop", transparent: true, format: 'image/png'},
     ...
     new OpenLayers.Layer.WMS(
            "Wilayah Sungai",
            'http://localhost:8080/geoserver/pupr2015/wms?',
            {layers: "pupr2015:ws_kalimantan", transparent: true, format: 'image/png'},
     ...
     new OpenLayers.Layer.WMS(
            ...
            'http://localhost:8080/geoserver/pupr2015/wms?',
            {layers: "pupr2015:das_kalimantan", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.9, isBaseLayer: false, visibility: false, noLegend: false, transitionEffect: 'resize', metadata: {
                wfs: {
                    protocol: 'fromWMSLayer'
                }
