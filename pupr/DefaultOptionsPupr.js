...
Heron.scratch.urls = {
    ...
    INDONESIA_TMS: 'http://openbasiskaart.nl/mapcache/tms'
};
...
Heron.scratch.layermap = {
    ...
    osmindonesia: ["OpenLayers.Layer.TMS", "Indonesia",
            Heron.scratch.urls.INDONESIA_TMS,
            {layername: 'osm@rd',
                type: "png",
                serverResolutions: Heron.options.serverResolutions.zoom_0_13,
                isBaseLayer: true,
...
//	Heron.scratch.layermap.pdok_natura2000_wmts,
    ...
    Heron.scratch.layermap.osmindonesia,
    //Heron.scratch.layermap.OsmSource,
